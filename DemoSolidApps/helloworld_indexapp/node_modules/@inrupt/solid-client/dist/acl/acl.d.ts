import type { WithResourceInfo, File, WithServerResourceInfo, UrlString, Url, SolidDataset, Thing } from "../interfaces";
/**
 ...
 */
export declare function getSolidDatasetWithAcl(url: UrlString | Url, options?: {
    fetch?: typeof fetch;
 ...
 * @since 0.2.0
 */
export declare function getFileWithAcl(input: Url | UrlString, options?: {
    fetch?: typeof fetch;
 ...
 */
export declare function getResourceInfoWithAcl(url: UrlString, options?: {
    fetch?: typeof fetch;
 ...
 * @param options Optional parameter `options.fetch`: An alternative `fetch` function to make the HTTP request, compatible with the browser-native [fetch API](https://developer.mozilla.org/docs/Web/API/WindowOrWorkerGlobalScope/fetch#parameters).
 */
export declare function saveAclFor(resource: WithAccessibleAcl, resourceAcl: SolidDataset, options?: {
    fetch?: typeof fetch;
 ...
 * @param options Optional parameter `options.fetch`: An alternative `fetch` function to make the HTTP request, compatible with the browser-native [fetch API](https://developer.mozilla.org/docs/Web/API/WindowOrWorkerGlobalScope/fetch#parameters).
 */
export declare function deleteAclFor<Resource extends WithResourceInfo & WithAccessibleAcl>(resource: Resource, options?: {
    fetch?: typeof fetch;
}): Promise<Resource & {
    acl: {
        resourceAcl: null;
