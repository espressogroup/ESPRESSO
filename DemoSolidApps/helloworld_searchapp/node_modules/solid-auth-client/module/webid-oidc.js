...
function _login() {
  _login = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee(idp, options) {
    var rp;
...
function _currentSession() {
  _currentSession = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee2() {
    var storage,
        rp,
        url,
        storeData,
    ...
    return _regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 21:
            return _context2.abrupt("return", _objectSpread(_objectSpread({}, session), {}, {
...
function _logout() {
  _logout = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee3(storage, fetch) {
    var rp;
...
function _getRegisteredRp() {
  _getRegisteredRp = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee4(idp, options) {
    var rp;
...
function _getStoredRp() {
  _getStoredRp = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee5(storage) {
    var data, rpConfig;
...
function _storeRp() {
  _storeRp = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee6(storage, idp, rp) {
...
function registerRp(idp, opts) {
  ...
  var registration = _objectSpread(_objectSpread({
    issuer: idp,
...
function _sendAuthRequest() {
  _sendAuthRequest = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee7(rp, _ref5) {
...
function _saveAppHashFragment() {
  _saveAppHashFragment = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee8(store) {
...
function _restoreAppHashFragment() {
  _restoreAppHashFragment = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee9(store) {
...
function _fetchWithCredentials() {
  _fetchWithCredentials = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee10(session, fetch, input, options) {
    var headers, popToken;
    return _regeneratorRuntime.wrap(function _callee10$(_context10) {
      while (1) {
        switch (_context10.prev = _context10.next) {
          case 0:
            // Add Authorization header (assuming a modifiable headers object)
            headers = (options ? options.headers : input.headers) || {};
            _context10.next = 3;
          ...
          case 3:
            ...
            return _context10.abrupt("return", fetch(input, _objectSpread(_objectSpread({}, options), {}, {
              credentials: 'include',
              headers: headers
            })));
