...
//	Use PROPRIETARY notice if class contains a main() method, otherwise use COPYRIGHT notice.
	...
	public PooledConnection getPooledConnection() throws SQLException {
		PooledConnection newPooledConnection = new com.ibm.gaiandb.jdbc.discoveryclient.GaianPooledConnection();
	...
	public PooledConnection getPooledConnection(String theUser,
		...
		PooledConnection newPooledConnection = new com.ibm.gaiandb.jdbc.discoveryclient.GaianPooledConnection(theUser, thePassword);
