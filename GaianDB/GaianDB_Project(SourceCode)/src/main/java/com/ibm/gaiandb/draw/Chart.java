 ...
 */
public abstract class Chart extends com.ibm.gaiandb.draw.DatabaseDiagram {
...
//	Use PROPRIETARY notice if class contains a main() method, otherwise use COPYRIGHT notice.
	...
	/**
	 * A set of field names that can be used to compare two rows in {@link}
	...
	public Chart(PreparedStatement statement, Object... params) throws SQLException {
		...
		firstStatementVar = com.ibm.gaiandb.draw.TableUtil.bindToPreparedStatement(statement, params);
	}
	...
	public synchronized void populateTable(Object... params) throws SQLException {
		com.ibm.gaiandb.draw.TableUtil.bindToPreparedStatement(statement, params, firstStatementVar);
		ResultSet resultSet = statement.executeQuery();

		beforeUpdate();
		data = com.ibm.gaiandb.draw.TableUtil.addResultSetToTable(resultSet, null, handler, keys);
		afterUpdate();
	...
	public synchronized void updateTable(Object... params) throws SQLException {
		...
		synchronized (data) {
			...
			beforeUpdate();
			com.ibm.gaiandb.draw.TableUtil.addResultSetToTable(resultSet, data, handler, keys);
			afterUpdate();
		}
