...
public class SolidServiceCall {
    ...
    public void filterData(String data) throws Exception {
        ...
        try {
            ...
            connection.setConnectTimeout(60000); // Set connection timeout to 10 seconds (10000 milliseconds)
            connection.setReadTimeout(180000);    // Set read timeout to 60 seconds (60000 milliseconds)
    ...
    public static void main(String[] args) {
        SolidServiceCall service = new SolidServiceCall();
        try {
            service.filterData("YourSearchQuery");
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
