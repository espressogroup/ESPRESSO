 ...
 *
 */
public class RegistrySeeker extends com.ibm.gaiandb.clientseeker.AbstractSeeker {
...
//	Use PROPRIETARY notice if class contains a main() method, otherwise use COPYRIGHT notice.
	 ...
	 */
	public com.ibm.gaiandb.clientseeker.RegistryDescriptor discoverFabricRegistry(long waitMillis) throws IOException, com.ibm.gaiandb.clientseeker.ResourceNotFoundException {
		...
		try {
			...
			if (responses.size() == 0) {
				throw new com.ibm.gaiandb.clientseeker.ResourceNotFoundException("Failed to discover a Fabric Registry using interface with IP " + request_interface_address);
			} else {
		...
		return new com.ibm.gaiandb.clientseeker.GaianRegistryDescriptorImpl(p.getAddress().getHostAddress());
	}
