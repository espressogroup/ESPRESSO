...
export * from './Core';
export declare type RegularFunctionMap = Record<C.RegularOperator, RegularFunction>;
export declare const regularFunctions: RegularFunctionMap;
export declare type SpecialFunctionAsyncMap = Record<C.SpecialOperator, SpecialFunction>;
export declare const specialFunctions: SpecialFunctionAsyncMap;
export declare type NamedFunctionMap = Record<C.NamedOperator, NamedFunction>;
