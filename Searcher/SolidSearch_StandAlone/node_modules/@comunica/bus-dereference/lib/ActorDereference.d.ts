...
export declare abstract class ActorDereference extends ActorDereferenceBase<IActionDereference, IActorTest, IActorDereferenceOutput> {
     ...
     */
    protected handleDereferenceErrors(action: IActionDereference, error: unknown, headers?: Headers | undefined, requestTime?: number): Promise<IActorDereferenceOutput>;
}
