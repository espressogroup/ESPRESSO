...
export declare abstract class ActorInit extends Actor<IActionInit, IActorTest, IActorOutputInit> {
     ...
     */
    constructor(args: IActorInitArgs);
}
/**
...
export declare type IActorInitArgs = IActorArgs<IActionInit, IActorTest, IActorOutputInit>;
export declare type MediatorInit = Mediate<IActionInit, IActorOutputInit>;
