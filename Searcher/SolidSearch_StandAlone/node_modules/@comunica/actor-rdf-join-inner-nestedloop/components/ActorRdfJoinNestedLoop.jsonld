{
  ...
  "@id": "npmd:@comunica/actor-rdf-join-inner-nestedloop",
  "components": [
    {
      "@id": "carjin:components/ActorRdfJoinNestedLoop.jsonld#ActorRdfJoinNestedLoop",
      "@type": "Class",
      "requireElement": "ActorRdfJoinNestedLoop",
      "extends": [
        "cbrj:components/ActorRdfJoin.jsonld#ActorRdfJoin"
      ],
      "comment": "A comunica NestedLoop RDF Join Actor.",
      "parameters": [
        {
          "@id": "carjin:components/ActorRdfJoinNestedLoop.jsonld#ActorRdfJoinNestedLoop_args_mediatorJoinSelectivity",
          "range": "cc:components/Mediator.jsonld#Mediator"
        },
        {
          "@id": "carjin:components/ActorRdfJoinNestedLoop.jsonld#ActorRdfJoinNestedLoop_args_name",
          "range": "xsd:string",
          "default": {
            "@id": "rdf:subject"
          },
        ...
        {
          "@id": "carjin:components/ActorRdfJoinNestedLoop.jsonld#ActorRdfJoinNestedLoop_args_bus",
          "range": {
        ...
        {
          "@id": "carjin:components/ActorRdfJoinNestedLoop.jsonld#ActorRdfJoinNestedLoop_args_beforeActors",
          "range": {
      ...
      "memberFields": [
        {
          "@id": "carjin:components/ActorRdfJoinNestedLoop.jsonld#ActorRdfJoinNestedLoop__member_constructor",
          "memberFieldName": "constructor"
        },
        {
          "@id": "carjin:components/ActorRdfJoinNestedLoop.jsonld#ActorRdfJoinNestedLoop__member_getOutput",
          "memberFieldName": "getOutput"
        },
        {
          "@id": "carjin:components/ActorRdfJoinNestedLoop.jsonld#ActorRdfJoinNestedLoop__member_getJoinCoefficients",
          "memberFieldName": "getJoinCoefficients"
        }
      ],
      "constructorArguments": [
        {
          "@id": "carjin:components/ActorRdfJoinNestedLoop.jsonld#ActorRdfJoinNestedLoop_args__constructorArgument",
          "fields": [
            {
