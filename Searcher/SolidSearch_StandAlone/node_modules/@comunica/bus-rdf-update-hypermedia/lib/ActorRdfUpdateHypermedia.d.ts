 ...
 */
export declare abstract class ActorRdfUpdateHypermedia extends Actor<IActionRdfUpdateHypermedia, IActorTest, IActorRdfUpdateHypermediaOutput> {
    protected readonly destinationType: string;
    /**
     * @param args - @defaultNested {<default_bus> a <cc:components/Bus.jsonld#Bus>} bus
     * @param destinationType - The destination type.
     */
    constructor(args: IActorRdfUpdateHypermediaArgs, destinationType: string);
    test(action: IActionRdfUpdateHypermedia): Promise<IActorTest>;
    abstract testMetadata(action: IActionRdfUpdateHypermedia): Promise<IActorTest>;
}
...
export declare type IActorRdfUpdateHypermediaArgs = IActorArgs<IActionRdfUpdateHypermedia, IActorTest, IActorRdfUpdateHypermediaOutput>;
export declare type MediatorRdfUpdateHypermedia = Mediate<IActionRdfUpdateHypermedia, IActorRdfUpdateHypermediaOutput>;
