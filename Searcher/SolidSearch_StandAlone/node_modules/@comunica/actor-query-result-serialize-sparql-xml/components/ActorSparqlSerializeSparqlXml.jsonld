{
  ...
  "@id": "npmd:@comunica/actor-query-result-serialize-sparql-xml",
  "components": [
    {
      "@id": "casssx:components/ActorQueryResultSerializeSparqlXml.jsonld#ActorQueryResultSerializeSparqlXml",
      "@type": "Class",
      "requireElement": "ActorQueryResultSerializeSparqlXml",
      "extends": [
        "cbss:components/ActorQueryResultSerializeFixedMediaTypes.jsonld#ActorQueryResultSerializeFixedMediaTypes"
      ],
      "comment": "A comunica sparql-results+xml Serialize Actor.",
      "parameters": [
        {
          "@id": "casssx:components/ActorQueryResultSerializeSparqlXml.jsonld#ActorQueryResultSerializeSparqlXml_args_mediaTypePriorities",
          "range": "rdf:JSON",
          "default": {
            "@type": "@json",
            "@value": {
        ...
        {
          "@id": "casssx:components/ActorQueryResultSerializeSparqlXml.jsonld#ActorQueryResultSerializeSparqlXml_args_mediaTypeFormats",
          "range": "rdf:JSON",
          "default": {
            "@type": "@json",
            "@value": {
        ...
        {
          "@id": "casssx:components/ActorQueryResultSerializeSparqlXml.jsonld#ActorQueryResultSerializeSparqlXml_args_priorityScale",
          "range": {
        ...
        {
          "@id": "casssx:components/ActorQueryResultSerializeSparqlXml.jsonld#ActorQueryResultSerializeSparqlXml_args_name",
          "range": "xsd:string",
          "default": {
            "@id": "rdf:subject"
          },
        ...
        {
          "@id": "casssx:components/ActorQueryResultSerializeSparqlXml.jsonld#ActorQueryResultSerializeSparqlXml_args_bus",
          "range": {
        ...
        {
          "@id": "casssx:components/ActorQueryResultSerializeSparqlXml.jsonld#ActorQueryResultSerializeSparqlXml_args_beforeActors",
          "range": {
            "@type": "ParameterRangeUnion",
            "parameterRangeElements": [
              {
      ...
      "memberKeys": [
        "constructor",
        "bindingToXmlBindings",
        "testHandleChecked",
        "runHandle"
      ],
      "constructorArguments": [
        {
          "@id": "casssx:components/ActorQueryResultSerializeSparqlXml.jsonld#ActorQueryResultSerializeSparqlXml_args__constructorArgument",
          "fields": [
            {
