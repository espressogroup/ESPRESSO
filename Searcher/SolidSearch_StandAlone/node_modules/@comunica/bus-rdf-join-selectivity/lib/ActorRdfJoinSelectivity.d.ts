 ...
 */
export declare abstract class ActorRdfJoinSelectivity extends Actor<IActionRdfJoinSelectivity, IMediatorTypeAccuracy, IActorRdfJoinSelectivityOutput> {
    /**
     * @param args - @defaultNested {<default_bus> a <cc:components/Bus.jsonld#Bus>} bus
     */
    constructor(args: IActorRdfJoinSelectivityArgs);
}
...
export declare type IActorRdfJoinSelectivityArgs = IActorArgs<IActionRdfJoinSelectivity, IMediatorTypeAccuracy, IActorRdfJoinSelectivityOutput>;
export declare type MediatorRdfJoinSelectivity = Mediate<IActionRdfJoinSelectivity, IActorRdfJoinSelectivityOutput, IMediatorTypeAccuracy>;
