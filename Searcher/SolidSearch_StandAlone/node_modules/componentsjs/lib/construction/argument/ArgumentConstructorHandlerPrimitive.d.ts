 ...
 */
export declare class ArgumentConstructorHandlerPrimitive implements IArgumentConstructorHandler {
    canHandle<Instance>(value: Resource, settings: IConstructionSettings, argsCreator: IArgumentsConstructor<Instance>): boolean;
    handle<Instance>(value: Resource, settings: IConstructionSettings, argsCreator: IArgumentsConstructor<Instance>): Promise<Instance>;
}
