...
export declare abstract class ActorAbstractMediaTyped<HI, HT, HO> extends Actor<IActionAbstractMediaTyped<HI>, IActorTestAbstractMediaTyped<HT>, IActorOutputAbstractMediaTyped<HO>> {
     ...
     */
    abstract runHandle(action: HI, mediaType: string | undefined, context: IActionContext): Promise<HO>;
    /**
     ...
     */
    abstract getMediaTypes(context: IActionContext): Promise<Record<string, number>>;
    /**
     ...
     */
    abstract getMediaTypeFormats(context: IActionContext): Promise<Record<string, string>>;
}
...
export declare type MediateMediaTypes = Mediate<IActionAbstractMediaTypedMediaTypes, IActorOutputAbstractMediaTypedMediaTypes, IActorTestAbstractMediaTypedMediaTypes>;
export declare type MediateMediaTyped<I extends IAction, T extends IActorTest, O extends IActorOutput> = Mediate<IActionAbstractMediaTypedHandle<I>, IActorOutputAbstractMediaTypedHandle<O>, IActorTestAbstractMediaTypedHandle<T>>;
