{
  ...
  "@id": "npmd:@comunica/actor-rdf-join-inner-single",
  "components": [
    {
      "@id": "carjisi:components/ActorRdfJoinSingle.jsonld#ActorRdfJoinSingle",
      "@type": "Class",
      "requireElement": "ActorRdfJoinSingle",
      "extends": [
        "cbrj:components/ActorRdfJoin.jsonld#ActorRdfJoin"
      ],
      "comment": "A comunica Single RDF Join Actor.",
      "parameters": [
        {
          "@id": "carjisi:components/ActorRdfJoinSingle.jsonld#ActorRdfJoinSingle_args_mediatorJoinSelectivity",
          "range": "cc:components/Mediator.jsonld#Mediator"
        },
        {
          "@id": "carjisi:components/ActorRdfJoinSingle.jsonld#ActorRdfJoinSingle_args_name",
          "range": "xsd:string",
          "default": {
            "@id": "rdf:subject"
          },
        ...
        {
          "@id": "carjisi:components/ActorRdfJoinSingle.jsonld#ActorRdfJoinSingle_args_bus",
          "range": {
        ...
        {
          "@id": "carjisi:components/ActorRdfJoinSingle.jsonld#ActorRdfJoinSingle_args_beforeActors",
          "range": {
      ...
      "memberFields": [
        {
          "@id": "carjisi:components/ActorRdfJoinSingle.jsonld#ActorRdfJoinSingle__member_constructor",
          "memberFieldName": "constructor"
        },
        {
          "@id": "carjisi:components/ActorRdfJoinSingle.jsonld#ActorRdfJoinSingle__member_test",
          "memberFieldName": "test"
        },
        {
          "@id": "carjisi:components/ActorRdfJoinSingle.jsonld#ActorRdfJoinSingle__member_getOutput",
          "memberFieldName": "getOutput"
        },
        {
          "@id": "carjisi:components/ActorRdfJoinSingle.jsonld#ActorRdfJoinSingle__member_getJoinCoefficients",
          "memberFieldName": "getJoinCoefficients"
        }
      ],
      "constructorArguments": [
        {
          "@id": "carjisi:components/ActorRdfJoinSingle.jsonld#ActorRdfJoinSingle_args__constructorArgument",
          "fields": [
            {
