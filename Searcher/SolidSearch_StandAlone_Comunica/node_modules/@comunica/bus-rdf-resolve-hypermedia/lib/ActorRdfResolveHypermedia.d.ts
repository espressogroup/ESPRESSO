...
export declare abstract class ActorRdfResolveHypermedia extends Actor<IActionRdfResolveHypermedia, IActorRdfResolveHypermediaTest, IActorRdfResolveHypermediaOutput> {
     ...
     */
    constructor(args: IActorRdfResolveHypermediaArgs, sourceType: string);
...
export declare type IActorRdfResolveHypermediaArgs = IActorArgs<IActionRdfResolveHypermedia, IActorRdfResolveHypermediaTest, IActorRdfResolveHypermediaOutput>;
export declare type MediatorRdfResolveHypermedia = Mediate<IActionRdfResolveHypermedia, IActorRdfResolveHypermediaOutput, IActorRdfResolveHypermediaTest>;
