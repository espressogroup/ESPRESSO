{
  ...
  "@id": "npmd:@comunica/actor-query-operation-filter-sparqlee",
  "components": [
    {
      "@id": "caqofs:components/ActorQueryOperationFilterSparqlee.jsonld#ActorQueryOperationFilterSparqlee",
      "@type": "Class",
      "requireElement": "ActorQueryOperationFilterSparqlee",
      "extends": [
        {
      ...
      "comment": "A comunica Filter Sparqlee Query Operation Actor.",
      "parameters": [
        {
          "@id": "caqofs:components/ActorQueryOperationFilterSparqlee.jsonld#ActorQueryOperationFilterSparqlee_args_mediatorQueryOperation",
          "range": "cc:components/Mediator.jsonld#Mediator"
        },
        {
          "@id": "caqofs:components/ActorQueryOperationFilterSparqlee.jsonld#ActorQueryOperationFilterSparqlee_args_name",
          "range": "xsd:string",
          "default": {
            "@id": "rdf:subject"
          },
        ...
        {
          "@id": "caqofs:components/ActorQueryOperationFilterSparqlee.jsonld#ActorQueryOperationFilterSparqlee_args_bus",
          "range": {
        ...
        {
          "@id": "caqofs:components/ActorQueryOperationFilterSparqlee.jsonld#ActorQueryOperationFilterSparqlee_args_beforeActors",
          "range": {
      ...
      "memberFields": [
        {
          "@id": "caqofs:components/ActorQueryOperationFilterSparqlee.jsonld#ActorQueryOperationFilterSparqlee__member_constructor",
          "memberFieldName": "constructor"
        },
        {
          "@id": "caqofs:components/ActorQueryOperationFilterSparqlee.jsonld#ActorQueryOperationFilterSparqlee__member_testOperation",
          "memberFieldName": "testOperation"
        },
        {
          "@id": "caqofs:components/ActorQueryOperationFilterSparqlee.jsonld#ActorQueryOperationFilterSparqlee__member_runOperation",
          "memberFieldName": "runOperation"
        }
      ],
      "constructorArguments": [
        {
          "@id": "caqofs:components/ActorQueryOperationFilterSparqlee.jsonld#ActorQueryOperationFilterSparqlee_args__constructorArgument",
          "fields": [
            {
