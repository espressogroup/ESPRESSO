...
exports.ConstructorArgumentsElementMappingHandlerCollectEntries = void 0;
const Iris_1 = require("../../rdf/Iris");
const ErrorResourcesContext_1 = require("../../util/ErrorResourcesContext");
/**
 * Handler for dynamic key-value pairs via collectEntries.
 */
class ConstructorArgumentsElementMappingHandlerCollectEntries {
    ...
    handleCollectEntry(entryResource, configRoot, constructorArgs, configElement, mapper, genericsContext) {
        ...
        if (constructorArgs.property.key) {
            ...
            if (constructorArgs.properties.key.length > 1) {
                throw new ErrorResourcesContext_1.ErrorResourcesContext(`Detected more than one key definition in collectEntries`, {
                    constructorArgs,
            ...
            if (constructorArgs.property.key.type === 'NamedNode' &&
                constructorArgs.property.key.value === Iris_1.IRIS_RDF.subject) {
                ...
                throw new ErrorResourcesContext_1.ErrorResourcesContext(`Detected more than one key value in collectEntries`, {
        ...
        if (constructorArgs.properties.value.length > 1) {
            throw new ErrorResourcesContext_1.ErrorResourcesContext(`Detected more than one value definition in collectEntries`, {
                constructorArgs,
                collectEntry: entryResource,
                config: configRoot,
            });
        ...
        if (constructorArgs.property.value.type === 'NamedNode' &&
            constructorArgs.property.value.value === Iris_1.IRIS_RDF.subject) {
...
exports.ConstructorArgumentsElementMappingHandlerCollectEntries = ConstructorArgumentsElementMappingHandlerCollectEntries;
//# sourceMappingURL=ConstructorArgumentsElementMappingHandlerCollectEntries.js.map