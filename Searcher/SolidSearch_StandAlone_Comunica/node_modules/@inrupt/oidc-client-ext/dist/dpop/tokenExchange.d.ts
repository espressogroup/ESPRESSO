import { IClient, IIssuerConfig, KeyPair, TokenEndpointResponse } from "@inrupt/solid-client-authn-core";
export declare type CodeExchangeResult = TokenEndpointResponse & {
    idToken: string;
    webId: string;
    dpopKey?: KeyPair;
};
