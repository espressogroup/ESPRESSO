...
/**
 ...
 @extends module:asynciterator.AsyncIterator
*/
export class MappingIterator extends AsyncIterator {
    /**
 ...
 */
export class WrappingIterator extends AsyncIterator {
 ...
 */
export function fromIterator(source) {
...
export function isEventEmitter(object) {
...
export function isSourceExpression(object) {
...
export function isIterator(object) {
