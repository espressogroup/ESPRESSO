...
export declare class FederatedQuadSource implements IQuadSource {
    ...
    constructor(mediatorResolveQuadPattern: MediatorRdfResolveQuadPattern, context: IActionContext, emptyPatterns: Map<IDataSource, RDF.Quad[]>, skipEmptyPatterns: boolean);
    /**
