{
  ...
  "@type": "Module",
  "requireName": "@comunica/actor-rdf-resolve-quad-pattern-federated",
  "import": [
    "carrqpf:components/ActorRdfResolveQuadPatternFederated.jsonld",
    "carrqpf:components/FederatedQuadSource.jsonld"
  ]
}