...
export declare class Runner {
    readonly busInit: Bus<Actor<IAction, IActorTest, IActorOutput>, IAction, IActorTest, IActorOutput>;
     ...
     */
    constructor(busInit: Bus<Actor<IAction, IActorTest, IActorOutput>, IAction, IActorTest, IActorOutput>, actors: Actor<IAction, IActorTest, IActorOutput>[]);
    /**
