...
def createexperiment(podname):
    ...
    experiment.loadserverlist(serverlist1)
    #experiment.loadserverlist(serverlist2,'Personal')
    print('serverlist loaded')
    #experiment.createlogicalpairedpods(33,0,serverlabel1='server',serverlabel2='server',podlabel1='NHSPod',podlabel2='PersonalPod',conpred=URIRef('http://espresso.org/haspersonalWebID'))
    experiment.createlogicalpods(33,0,zipf=0)
    ...
    experiment.logicaldistfilestopodsfrompool(330,0,'text/plain','medhist','pod','GPrecords',predicatetopod='')
    experiment.distributebundles(33,sourcedir2,'text/turtle','fit','fit','pod',URIRef('http://espresso.org/hasFitActivity'),'123,456,789,ABC,DEF')
    ...
    experiment.imagineaclnormal(10,numofwebids,mean, disp,filelabel='medhist')
...
zip(experiment,zipdir,sys.argv[1],sys.argv[2])