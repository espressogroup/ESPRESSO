...
def zipindex(experiment,dir,filename):
    experiment.assignlocalimage(dir)
    experiment.saveexp(filename)


serverlist1=serverlistglobal[14:15]
serverlist2=serverlistglobal[15:20]
sourcedir1='/Users/yurysavateev/ESPRESSO/fhir_ragabola'
sourcedir2='/Users/yurysavateev/ESPRESSO/FIT_OUTPUT'
sourcedir3='/Users/yurysavateev/ESPRESSO/ESPRESSOExperiments/medhist'
dir='/Users/yurysavateev/ESPRESSO/'
podname='ardfhealth'
...
def createexperiment(experiment):
    experiment.loadserverlist(serverlist1,'NHS')
    experiment.loadserverlist(serverlist2,'Personal')
    print('serverlist loaded')
    experiment.createlogicalpairedpods(33,0,'NHS','Personal',podlabel1='NHSPod',podlabel2='PersonalPod',conpred=URIRef('http://espresso.org/haspersonalWebID'))

    #experiment.loaddir(sourcedir1,'FHIR','text/turtle')
    experiment.loaddirtopool(sourcedir1,'FHIR')
    experiment.loaddirtopool(sourcedir3,'medhist')
    experiment.logicaldistfilestopodsfrompool(165,0,'text/turtle','FHIR','NHSPod','hospitalrecords',URIRef('http://espresso.org/hasHospitalRecord'),True)
    experiment.logicaldistfilestopodsfrompool(330,0,'text/plain','medhist','NHSPod','GPrecords',predicatetopod='')
    experiment.logicaldistfilestopodsfrompool(330,0,'text/plain','medhist','PersonalPod','GPrecords',predicatetopod='')
    experiment.distributebundles(33,sourcedir2,'text/turtle','fit','fit','PersonalPod',URIRef('http://espresso.org/hasFitActivity'),'123,456,789,ABC,DEF')
    print('files loaded')
#experiment.logicaldist(numberofpods,0,0)
    print('files distributed')
#experiment.imagineaclnormal(openperc,numofwebids,mean,disp)
    experiment.imagineaclnormal(100,0,mean, disp,filelabel='FHIR')
    experiment.imagineaclnormal(100,0,mean, disp,filelabel='fit')
    experiment.imagineaclnormal(10,numofwebids,mean, disp,filelabel='fit')
    experiment.imagineaclspecial(percs,'FHIR')
    experiment.imagineaclspecial(percs,'medhist')
    experiment.imagineaclspecial(percs,'fit')
...
experiment=flexexperiment.loadexp(podname+'expfixed.ttl')
print('Experiment loaded')
#deployexperiment(experiment)
#uploadexperiment(experiment)
#indexexperiment(experiment)
zipindex(experiment,dir,podname+'exp.ttl')