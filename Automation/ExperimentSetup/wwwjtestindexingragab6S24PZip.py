...
def createexperiment(podname):
    serverlist=serverlistglobal[0:1] + serverlistglobal[2:7] 
    
    sourcedir='/Users/ragab/Downloads/wwwjnewdatsetwise/dataset/'
    ...
    print('files loaded')
    experiment.createlogicalpods(24,0)
    experiment.logicaldistfilestopodsfrompool(100,0,'text/plain',filelabel='file',podlabel='pod',subdir='file',predicatetopod='',replacebool=False, zipf=1)
    

    print('files distributed')
#experiment.imagineaclnormal(openperc,numofwebids,mean,disp)
    experiment.initanodelist(numofwebids)
    experiment.initsanodelist(percs)
    experiment.imagineaclnormal(0,mean, disp)
    experiment.imagineaclspecial()
    print('files acl imagined')
    experiment.saveexp(podname+'exp.ttl')

    print('experiment saved')

podname='wwwjindexing6s24pzipf'
zipdir='/Users/ragab/Downloads/wwwjindexingzips/'+podname+'/'
