...
def createexperiment(podname):
    serverlist=serverlistglobal[48:49]
    ...
    experiment.logicaldistfilestopodsfrompool(50000,0,'text/plain',filelabel='file',podlabel='pod',subdir='file',predicatetopod='',replacebool=False,zipf=1)
