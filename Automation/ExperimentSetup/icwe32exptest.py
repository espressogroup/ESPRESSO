...
def createexperiment(podname):
    serverlist=serverlistglobal[25:35]
    ...
    print('files loaded')
    experiment.createlogicalpods(100,0)
    experiment.logicaldistfilestopodsfrompool(100000,0,'text/plain',filelabel='file',podlabel='pod',subdir='file',predicatetopod='',replacebool=False)
