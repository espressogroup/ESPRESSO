...
def createexperiment(podname):
    serverlist=serverlistglobal[14:24]
    
    sourcedir='/Users/yurysavateev/ESPRESSO/ESPRESSOExperiments/100000f5MB/'
    ...
    print('files loaded')
    experiment.createlogicalpods(50,0,zipf=1)
    experiment.logicaldistfilestopodsfrompool(100000,0,'text/plain',filelabel='file',podlabel='pod',subdir='file',predicatetopod='',replacebool=False,zipf=0)
