...
def createexperiment(podname):
    ...
    experiment.logicaldistfilestopodsfrompool(100,0,'text/plain',filelabel='file',podlabel='pod',subdir='file',predicatetopod='',replacebool=False)
...
podname='wwwjindexing6s24puniform'
