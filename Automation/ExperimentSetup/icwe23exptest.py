...
def createexperiment(podname):
    serverlist=serverlistglobal[10:11]
    ...
    experiment.logicaldistfilestopodsfrompool(10000,0,'text/plain',filelabel='file',podlabel='pod',subdir='file',predicatetopod='',replacebool=False)
