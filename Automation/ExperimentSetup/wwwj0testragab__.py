...
def createexperiment(podname):
    ...
    sourcedir='/Users/ragab/Downloads/syntheagenerate/output/text/'
    ...
    experiment.logicaldistfilestopodsfrompool(3,0,'text/plain',filelabel='file',podlabel='pod',subdir='file',predicatetopod='',replacebool=False)
