...
def createexperiment(podname):
    serverlist=serverlistglobal[38:39]
    ...
    experiment.logicaldistfilestopodsfrompool(100000,0,'text/plain',filelabel='file',podlabel='pod',subdir='file',predicatetopod='',replacebool=False,zipf=1)
